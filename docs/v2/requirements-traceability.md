...
| RUNTIME-006 | Worker threads receive immutable copied data and late/cancelled results cannot mutate current state. | Async Paint planning | `PaintPlanningWorker` + application commands/generations | T1, T2 | Bridge job globals |

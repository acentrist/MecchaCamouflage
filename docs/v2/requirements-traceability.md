...
| PAINT-012 | Preview captures all changed channels and exact restore is guarded against wrong component/repeat use. | Bridge preview export/import | core preview compositor + `PaintPreviewController` + runtime adapter | T1, T2, T4 | Import/export bridge commands |

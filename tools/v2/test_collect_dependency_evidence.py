...
class DependencyEvidenceTests(unittest.TestCase):
    ...
    def make_fixture(self, root: Path) -> tuple[
        ...
        ue4ss_head = self.init_repository(ue4ss, "ue4ss")
        ...
        (project / "rust/bind/Cargo.toml").write_text(
            ...
            "packages": [
                {
                    ...
                    "source": None,
                    "manifest_path":
                        str(project / "rust/bind/Cargo.toml"),
                },
                {
                    "name": "serde",
                    "version": "1.0.0",
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(
                ...
                [
                    ...
                    "proxy@project:third_party/ue4ss/proxy",
                    "UE4SS@project:third_party/ue4ss",
                ],
            )
